...
import de.aflx.sardine.StupidSSLSocketFactory;
...
public class SardineImpl implements Sardine {
     ...
     */
    public SardineImpl() throws KeyManagementException, NoSuchAlgorithmException, KeyStoreException,
     ...
     * @throws CertificateException 
     */
    public SardineImpl(String username, String password) throws KeyManagementException, NoSuchAlgorithmException,
     ...
     * @param withCertificationChecks - use this parameter to control the ssl-certificate proof behavior. Useful for self-signed certificates!
     * @throws UnrecoverableKeyException
     * @throws KeyStoreException
     * @throws NoSuchAlgorithmException
     * @throws KeyManagementException
     ...
     * @throws CertificateException 
     */
    public SardineImpl(String username, String password, ProxySelector selector, boolean withCertificationChecks) throws KeyManagementException,
	    NoSuchAlgorithmException, KeyStoreException, UnrecoverableKeyException, CertificateException, IOException {
	this.init(this.createDefaultClient(selector, withCertificationChecks), username, password);
    }
	...
	entity.setEntity(new StringEntity(
     ...
     * namespace and
     * {@link de.aflx.sardine.util.SardineUtil#CUSTOM_NAMESPACE_PREFIX} as
     * prefix.
     */
	 ...
	 * remove.setProp(prop);
	 * }
	 * // entity.setEntity(new StringEntity(SardineUtil.toXml(body),
	 * UTF_8));
     ...
     * (non-Javadoc)
     * 
     * @see de.aflx.sardine.Sardine#unlock(java.lang.String, java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see de.aflx.sardine.Sardine#put(java.lang.String, java.io.InputStream)
     */
     ...
     * (non-Javadoc)
     * 
     * @see de.aflx.sardine.Sardine#move(java.lang.String, java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see de.aflx.sardine.Sardine#copy(java.lang.String, java.lang.String)
     */
     ...
     * @throws IOException
     */
    protected AbstractHttpClient createDefaultClient(ProxySelector selector, boolean withCerticiationChecks) throws KeyManagementException,
	    NoSuchAlgorithmException, KeyStoreException, UnrecoverableKeyException, CertificateException, IOException {
	SchemeRegistry schemeRegistry = this.createDefaultSchemeRegistry(withCerticiationChecks);
     ...
     * 
     * Use the parameter to control, if the given certification should be checked or not.
     * Useful for self-signed certificates!
     * 
     * @param withCertificationChecks
     * @return
     * @throws KeyManagementException
     * @throws NoSuchAlgorithmException
     * @throws KeyStoreException
     ...
     * @throws IOException
     */
    protected SchemeRegistry createDefaultSchemeRegistry(boolean withCertificationChecks) throws KeyManagementException, NoSuchAlgorithmException,
	    KeyStoreException, UnrecoverableKeyException, CertificateException, IOException {
	SchemeRegistry registry = new SchemeRegistry();
	registry.register(new Scheme("http", this.createDefaultSocketFactory(), 80));
	
	if(withCertificationChecks) {
	    registry.register(new Scheme("https", this.createDefaultSecureSocketFactory(), 443));
	} else {
	    registry.register(new Scheme("https", this.createDefaultUnSecureSocketFactory(), 443));
	}
     ...
     * @throws CertificateException 
     */
    protected SSLSocketFactory createDefaultSecureSocketFactory() throws KeyManagementException,
	    NoSuchAlgorithmException, KeyStoreException, UnrecoverableKeyException, CertificateException, IOException {
	...
	return new StupidSSLSocketFactory(trustStore);
    }
    
    /**
     * Return an {@link SSLSocketFactory} whuch skip all ssl-certification checks.
     * @return Default SSL socket factory
     * @throws UnrecoverableKeyException
     * @throws KeyStoreException
     * @throws NoSuchAlgorithmException
     ...
     * @throws CertificateException 
     */
    protected SSLSocketFactory createDefaultUnSecureSocketFactory() throws KeyManagementException,
	    NoSuchAlgorithmException, KeyStoreException, UnrecoverableKeyException, CertificateException, IOException {
